class SnakeGame {
    constructor() {
        ...
        this.baseInterval = 150; // Возвращаем оригинальный интервал
        this.fpsInterval = 1000 / 60; // Возвращаем стандартный FPS
        
        // Оптимизация для мобильных устройств
        this.isMobile = window.innerWidth <= 768;
        this.maxParticles = this.isMobile ? 10 : 30; // Уменьшаем количество частиц на мобильных
    ...
    restart() {
        // Сбрасываем счетчик рекламы при полном рестарте
        this.adRevivalsUsed = 0;
        this.deathCount = 0;
    ...
    createGameOverScreen() {
        ...
        // Reset ad revivals counter if it's a new game session
        ...
        retryButton.onclick = () => {
            this.adRevivalsUsed = 0; // Сбрасываем счетчик при новой игре
            this.restart();
        };
