class SnakeGame {
    constructor() {
        ...
        this.inputDelay = 30; // Уменьшаем задержку между нажатиями
        this.lastInputTime = 0;
        this.gameRunning = false;
        this.startPosition = { x: 5, y: 5 };
        this.baseInterval = 120; // Уменьшаем базовый интервал для более плавного движения
        this.fpsInterval = 1000 / 120; // Увеличиваем частоту обновления для плавности
